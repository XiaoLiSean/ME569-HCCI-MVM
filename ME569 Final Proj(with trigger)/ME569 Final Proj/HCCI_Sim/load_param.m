...
m1_0        = p0*V1/(R*T1); % Intake manifold charge mass, g
m2_0        = p0*V2/(R*T1); % Exhaust manifold charge mass, g
b1_0        = 0; % Intake manifold burnt gas fraction
b2_0        = 0; % Exhaust manifold burnt gas fraction
